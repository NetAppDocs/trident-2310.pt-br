...
[role="lead"]
Se você não estiver executando o Astra Trident 23,10, a documentação das versões anteriores estará disponível com base link:get-help.html["Ciclo de vida do suporte ao Astra Trident"]no .
