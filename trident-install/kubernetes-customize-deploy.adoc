...
| `autosupportImage` | A imagem do recipiente para a telemetria AutoSupport | `"netapp/trident-autosupport:23.10"` 
...
| `tridentImage` | Imagem Astra Trident a instalar | `"netapp/trident:23.10"` 
