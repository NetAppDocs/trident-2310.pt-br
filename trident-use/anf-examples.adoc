...
| `tenantID` | O ID do locatário de um Registo de aplicações opcional quando as identidades geridas estão ativadas num cluster AKS. |  


| `clientID` | A ID do cliente de um registo de aplicações opcional quando as identidades geridas estão ativadas num cluster AKS. |  


| `clientSecret` | O segredo do cliente de um Registo de aplicações Opcional quando identidades geridas está ativado num cluster AKS. |  
