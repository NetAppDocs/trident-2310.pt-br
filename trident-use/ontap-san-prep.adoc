...
----
+
++ NOTA: Após executar este comando, ONTAP solicitará a entrada do certificado. Cole o conteúdo do  `k8senv.pem` arquivo gerado na etapa 1 e pressione  `END` para concluir a instalação.
